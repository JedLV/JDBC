...
public class ConnectionDem012 {
    ...
    //定义MySQL数据库的链接地址
    public static final String DBURL = "jdbc:mysql://localhost:3306/girls?&useSSL=false";
    //MySQL数据库的连接用户名
    public static final String DBUSER = "root";
    //MySQL数据库的连接密码
    public static final String DBPASS = "mysqlmima123";

    public static void main(String[] args) throws Exception {
        Connection con = null;  //数据库链接
        Statement stmt = null;  //数据库的操作对象
        ResultSet rs = null;  //保存查询结果
        String sql = "SELECT id,name,sex,borndate,phone,photo,boyfriend_id FROM beauty";
        ...
        while (rs.next()){ //依次取出数据
            ...
            System.out.print("Id：" + boyfriendId + ";");
